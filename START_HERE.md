...
Conference deck built: `deck/Shomique_Hayat_UNIQ_antibiotic_agents.pptx`, 20 slides with speaker notes,
regenerated by `python3 deck/deck_figures.py && python3 deck/build_deck.py`. The talk brief, including
the question-and-answer drill and the rung-3 training design, is `BRIEFING.md`.
