...
Counterfactual ordering (organism first, then linkage) gives 7,796  to  3,104  to  1,087  to  993 -
...
| `untested_policy` | `'category'` | untested agent  to  UNDETERMINED, not counted wrong |
